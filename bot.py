...
async def build_player_history(team_id: int, season: int = CURRENT_SEASON):
    ...
    for fixture in fixtures[:5]:  # Limit to 5 most recent to save API calls
...
async def get_upcoming_matches(hours_ahead: int = 168):  # 7 days
...
def main():
    """Start bot"""
    logger.info("Starting On-Demand PL Position Analyzer...")
